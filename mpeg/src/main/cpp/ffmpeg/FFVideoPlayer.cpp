...
void Java_com_flutter_mpeg_SimpleVideoView_playVideo(JNIEnv *env, jobject instance,
                                                     jstring
                                                     path_, jobject surface) {
...
// 以及所提供的图像数据缓冲区。
    avpicture_fill((AVPicture
                   *) (dstFrame), out_buffer, AV_PIX_FMT_RGBA, avCodecContext->width,
