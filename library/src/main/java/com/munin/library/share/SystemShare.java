...
public class SystemShare {
     ...
     * Share content type
     */
    private @ShareType String contentType;
    ...
    public void shareBySystem () {
        if (checkShareParam()) {
            ...
            if (shareIntent == null) {
                Logger.e(TAG, "shareBySystem cancel.");
                return;
            }
    ...
    private Intent createShareIntent() {
        ...
        switch (contentType) {
            ...
            case ShareType.FILE:
                ...
                Logger.d(TAG, "Share uri: " + shareFileUri.toString());
                ...
                break;
            default:
                Logger.e(TAG, contentType + " is not support share type.");
                shareIntent = null;
                break;
        }
    ...
    private boolean checkShareParam() {
        ...
        if (TextUtils.isEmpty(this.contentType)) {
            Logger.e(TAG, "Share content type is empty.");
            return false;
        }

        if (ShareType.TEXT.equals(contentType)) {
            if (TextUtils.isEmpty(contentText)) {
                Logger.e(TAG, "Share text context is empty.");
                return false;
            }
        } else {
            if (this.shareFileUri == null) {
                Logger.e(TAG, "Share file path is null.");
                return false;
            }
        }
    ...
    public static class Builder {
        private Activity activity;
        private @ShareType String contentType = ShareType.FILE;
        private String title;
        private String componentPackageName;
        private String componentClassName;
        private Uri shareFileUri;
        ...
        /**
         * Set Content Type
         * @param contentType {@link ShareType}
         * @return Builder
         */
        public Builder setContentType(@ShareType String contentType) {
