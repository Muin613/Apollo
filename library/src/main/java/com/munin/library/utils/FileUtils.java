...
public class FileUtils {
     ...
     * @param shareContentType shareContentType {@link com.munin.library.share.ShareType}
     * @param file file
     * @return Uri
     */
    public static Uri getFileUri (Context context, @ShareType String shareContentType, File file){
